...
The current validated upstream target is **Claude Code 2.1.259**. cc-enhanced supports the latest upstream form only; older releases do not receive compatibility fallbacks.
