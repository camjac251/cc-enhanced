    ...
    case "dynamic_skill": {
      ...
      return Nq.jsxs(xw, {
        children: [
          "Loaded",
          " ",
          Nq.jsxs(v, { bold: !0, children: [A, " ", Y6(A, "skill")] }),
          " ",
          "from ",
          Nq.jsx(v, { bold: !0, children: H.displayPath }),
        ],
      });
    }
    case "skill_listing": {
      ...
      return Nq.jsxs(xw, {
        children: [
          Nq.jsx(v, { bold: !0, children: H.skillCount }),
          " ",
...
function renderAttachment(q, $) {
  switch (q.type) {
    case "dynamic_skill": {
      ...
      let O;
      if ($[88] !== z || $[89] !== Y)
        (O = yK.jsxs(y, { bold: !0, children: [z, " ", Y] })),
          ($[88] = z),
          ($[89] = Y),
          ($[90] = O);
      else O = $[90];
      let w;
      if ($[91] !== q.displayPath)
        (w = yK.jsx(y, { bold: !0, children: q.displayPath })),
          ($[91] = q.displayPath),
          ($[92] = w);
      else w = $[92];
      let M;
      if ($[93] !== O || $[94] !== w)
        (M = yK.jsxs(nP, { children: ["Loaded", " ", O, " ", "from ", w] })),
          ($[93] = O),
          ($[94] = w),
          ($[95] = M);
      else M = $[95];
    ...
    case "skill_listing": {
      ...
      let z;
      if ($[96] !== q.skillCount)
        (z = yK.jsx(y, { bold: !0, children: q.skillCount })),
          ($[96] = q.skillCount),
          ($[97] = z);
      else z = $[97];
      let Y;
      ...
      let O;
      if ($[100] !== z || $[101] !== Y)
        (O = yK.jsxs(nP, { children: [z, " ", Y, " available"] })),
          ($[100] = z),
          ($[101] = Y),
          ($[102] = O);
      else O = $[102];
...
test("skill-listing-ui patches the memoized render shape", async () => {
