...
mise run native:update 2.1.111      # Pin a specific version
mise run native:update --dry-run    # Preview without promoting
mise run native:fetch-patch 2.1.111 --dry-run  # Fetch + patch preview for a pinned version
...
Tested against **Claude Code 2.1.111**. The latest verified update passed on April 16, 2026. Only the latest upstream version is targeted. Older versions are not maintained or tested.
